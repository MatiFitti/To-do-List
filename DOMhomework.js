...
// ToDo.prototype.description = this.description;
...
function buildToDo(todo, index) {
  // Tu código acá:
  var toDoShell = document.createElement('div');//crea el div
  ...
  toDoShell.className = 'toDoShell';//Le asigna la clase
  toDoText.innerHTML = todo.description; //se le agrega el descrption a toDoText
  // toDoText.id = index; //se le asigna el id
  if (todo.complete === true){
    toDoText.classList.add('completeText'); //className le asigna, para asignarle otra se usa classList
    checkbox.setAttribute('checked', true)
  }
  toDoShell.appendChild(toDoText) // le asigna a toDoShell el hijo toDoText
  toDoShell.appendChild(checkbox) 
  // toDoText.addEventListener('click', completeToDo) //Evento a partir de un click ejecutando la funct completeToDo
  return toDoShell
}
